...
```python colab={"base_uri": "https://localhost:8080/"} id="PbnVxkXsE-gX" outputId="c77444c6-59a3-48a5-997b-20b38a7a0af7"
...
```python colab={"base_uri": "https://localhost:8080/", "height": 463} id="XL6XjRnoFd8j" outputId="dcec9618-ad94-4790-c8d6-651e3a93a770"
...
```python colab={"base_uri": "https://localhost:8080/", "height": 463} id="mIZOh2-xFwWf" outputId="96258c75-e785-404b-f2c8-8f832103aa12"
fig_counter +=1
...
```python colab={"base_uri": "https://localhost:8080/", "height": 564} id="s9b-zrG1Mue2" outputId="0bb7af04-ff64-472a-ca5f-68634477e80d"
fig_counter +=1
...
```python colab={"base_uri": "https://localhost:8080/", "height": 564} id="HOD0IxyytMPM" outputId="65fbb4cf-7331-45bd-ba18-41548a3c5ef6"
fig_counter += 1
...
```python id="U8k5e80GVa8a" outputId="6c37d114-5480-4e4b-fae6-ecbd129dbd28" colab={"base_uri": "https://localhost:8080/"}
...
```python id="NCIVtudYR4nY" outputId="6c042f3a-febc-486a-d178-8383fe22957a" colab={"base_uri": "https://localhost:8080/", "height": 975}
...
```python colab={"base_uri": "https://localhost:8080/", "height": 410} id="X6bom6B1Q97q" outputId="d9c06fd9-4e10-45a9-a264-bd65d16efd5d"
plot_outliers(Z=3)
```
...
```python id="FZ6OcVbKfVID" outputId="5a86e972-8c5a-4b99-b6d3-bcabce31d72b" colab={"base_uri": "https://localhost:8080/", "height": 315}
import numpy as np
import matplotlib.pyplot as plt
